...
# Ваш API Token
API_TOKEN = "7707238362:AAH6ViSbh4Do5pT1VS4veO7Fmpjelkx2vUg"
...
WELCOME_MESSAGES = {
    'ru': "👋Добро пожаловать в SATURN 🪐 RICH BOT!\n\n"
...
REGISTRATION_MESSAGE = {
    'ru':
          "🔷 1. Зарегистрируйтесь на сайте 1WIN по кнопке ниже (используйте промокод X500IZI , он даст вам 500% к депозиту)\n"
          ...
          "👨‍💻Если у вас есть вопросы, то напишите нашему менеджеру - @gdz_belov",
    
    'en': "🔷 1. Register on the 1WIN website using the button below (use promo code X500IZI for a 500% deposit bonus)\n"
          ...
          "👨‍💻If you have any questions, contact our manager - @gdz_belov"
}
...
async def send_registration_instructions(query, language: str, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            InlineKeyboardButton(REGISTRATION_BUTTON[language], url="https://1wxxlb.com/casino/list?open=register&p=nwdx")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
async def handle_user_id(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_valid_id(user_id):
        ...
        keyboard = [
            [
                InlineKeyboardButton("⭐️Mines", url="https://t.me/saturnrich_bot/mines"),
                InlineKeyboardButton("💣BomBucks", url="https://t.me/saturnrich_bot/bombucks"),
            ],
            [
                InlineKeyboardButton("🚀LuckyJet", url="https://t.me/saturnrich_bot/LuckyJet"),
                InlineKeyboardButton("💀BrawlPirates", url="https://t.me/saturnrich_bot/brawl"),
            ],
            [
                InlineKeyboardButton("🪙CoinFlip", url="https://t.me/saturnrich_bot/coin"),
                InlineKeyboardButton("🛩Aviator", url="https://t.me/saturnrich_bot/aviator"),
            ]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
